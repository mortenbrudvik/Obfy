...
### Changed
- Method IL encryption records generic skips in the report and uses a distinct XOR key per method; warns when many methods are skipped because they are generic (Windows-only, not NativeAOT)
