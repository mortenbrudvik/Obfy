...
| TR-03 | Confirm CI is green on `main` and the coverage artifact + 80% warning actually run. | S | High | Open — coverage comment needs `pull-requests: write`; 403 must not skip the 80% warning |
